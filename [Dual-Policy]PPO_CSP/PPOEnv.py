...
class Environment:
    def __init__(self, x_dim, y_dim, max_steps, num_players, num_bushes, 
                 ...
                 sensitive_percentage, max_lifespan, spont_growth_rate, verbose=False):
        self.x_dim = x_dim
        self.y_dim = y_dim
        ...
        self.bushes = []
        self.current_step = 0
        self.last_action_position = None  # Track the last action position
    ...
    def reset(self, environment, regrowth_rate, max_lifespan, spont_growth_rate):
        """
        ...
        self.bushes = []
        self.current_step = 0
        self.randomize_positions(regrowth_rate, max_lifespan, spont_growth_rate)  # Use the stored parameters
